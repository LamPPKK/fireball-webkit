...
- Focused-scene iPad keyboard commands for tabs, omnibox and navigation, with a Dynamic Type-aware status rail, adaptive settings cards, 48-point control targets and automated iPhone/iPad audits for browser chrome, tabs, library and settings.
